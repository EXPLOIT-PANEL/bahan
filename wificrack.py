...
from Settings.Program.banner import banner,clear
from Settings.Program.sprint import sprint
from Settings.Program.banner import ran,y,r,g,c
...
def help():
    print(f"\t{r}-> {c}Usage:~ {y}python3 wificrack.py <wordlist>\n\t{r}-> {c}python3 wificrack.py {y}(it wil use default wordlist")
    exit()
